...
public class Match {
    ...
    // set the status of match according to testComplete
    ...
    public Match(int match_id, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlTeam,
        String bowlTeamScore, String liveText, String matchLink, String textComplete, MatchStatus status, Date date) {
